...
<body class="bg-content">
    <main class="dashboard d-flex">
        ...
        <?php 
            ...
            $nbr_students = $con->query("SELECT * FROM finee");
    ...
    background-color:#F86F03;
        ...
        ?>
            <div class="cards row gap-3 justify-content-center mt-5">
                <div class=" card__items card__items--blue col-md-3 position-relative" id="first">
                ...
                <div class=" card__items card__items--rose col-md-3 position-relative"id="second">
                ...
                <div class=" card__items card__items--yellow col-md-3 position-relative"id="third">
                ...
                <div class="card__items card__items--gradient col-md-3 position-relative"id="fourth">
